...
SunRenderer::SunRenderer(Shader& other)
{
    shader = other;
    initRenderData();
}

SunRenderer::~SunRenderer() { glDeleteVertexArrays(1, &VAO); }

void SunRenderer::Draw(Texture texture, glm::vec3 position, GLfloat size)
{
    shader.use();
...
void SunRenderer::initRenderData()
{
    GLuint VBO;
...
glm::vec3 SunRenderer::getPoint(GLfloat u, GLfloat v) {
...
void SunRenderer::createSphere(GLfloat* sphere, GLuint Longitude, GLuint Latitude) {
